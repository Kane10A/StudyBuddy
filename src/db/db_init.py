import sqlite3
import os
from src.db.schemas import PROBLEMS_TABLE_SCHEMA, SOLUTIONS_TABLE_SCHEMA, ATTEMPTS_TABLE_SCHEMA, FEEDBACK_TABLE_SCHEMA, SOURCES_TABLE_SCHEMA

BASE_DIR = os.path.dirname(os.path.abspath(__file__))
DB_PATH = os.path.join(BASE_DIR, "..", "..", "study_helper.db")
